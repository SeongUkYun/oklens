...
<meta name="keywords" content="オルソケラトロジー、処方法、事前検査、適応検査">
<meta name="description" content="このサイトは、皆様にオルソケラトロジーの最新情報をお届けすることを目的としております。">  
<title>処方法ー事前検査｜オルソケラトロジー情報館</title>
             ...
             <tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   ...
                   <td width="68">&nbsp;</td>
                   <td width="610" valign="bottom"><img src="image/doctor/md_title006.gif" width="443" height="29"></td>
                 </tr>
               </table>
			   </td>
             </tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
				   ...
				   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                       <td align="center"><img src="image/doctor/d_simg001.jpg" ></td>
                     </tr>
                     <tr>
                       <td height="10"></td>
                     </tr>
                     <tr>
                       <td align="right"><img src="image/doctor/stitle.gif" width="359" height="19" hspace="15"></td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
                     </tr>
