...
<meta name="keywords" content="オルソケラトロジー,費用,価格　">
<meta name="description" content="このサイトは、皆様にオルソケラトロジーの最新情報をお届けすることを目的としております。"> 
<title>費用はどのくらい？｜オルソケラトロジー情報館</title>
             ...
             <tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   ...
                   <td width="68">&nbsp;</td>
                   <td width="610" valign="bottom"><img src="image/patient/meun_title006.gif" width="260" height="33"></td>
                 </tr>
               </table>
			   </td>
             </tr>
             ...
             <tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
				   ...
				   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                       <td><img src="image/patient/bodytiltle08.gif" width="460" height="21"></td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
                     </tr>
                     <tr>
                       <td align="center"><img src="image/patient/mon.jpg" border="0" usemap="#Map"></td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
                     </tr>
...
<map name="Map">
  <area shape="rect" coords="163,340,280,366" href="http://www.nta.go.jp/shiraberu/zeiho-kaishaku/shitsugi/shotoku/05/66.htm" target="_blank">
</map></body>
</html>
