...
<meta name="keywords" content="オルソケラトロジー、処方法、適応、不適応">
<meta name="description" content="このサイトは、皆様にオルソケラトロジーの最新情報をお届けすることを目的としております。">  
<title>処方法ー適用/不適用｜オルソケラトロジー情報館</title>
             ...
             <tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   ...
                   <td width="68">&nbsp;</td>
                   <td width="610" valign="bottom"><img src="image/doctor/md_title005.gif" width="443" height="29"></td>
                 </tr>
               </table>
			   </td>
             </tr>
             ...
             <tr>
			   ...
			   <table width="852" border="0" cellspacing="0" cellpadding="0">
                 <tr>
				   ...
				   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                       <td><img src="image/doctor/pre01.jpg" width="586"></td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
                     </tr>
